...
# I train a few regression models.
...
# This section shows H2O capabilities.
  ...
  m = h2o.glm(x = x, y = y, training_frame = h2o_train)                  # Generalized linear model
...
# This section shows how to get LIME explanations for the models trained above.
  ...
  explanation <- lime::explain(as.data.frame(h2o_test[5,]), explainer, n_features = 3)
